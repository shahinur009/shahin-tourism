...
const Footer = () => {
    return (
        <>
            <footer className="px-10 my-10 divide-y dark:bg-gray-700 text-white bg-slate-800 rounded-md">
                <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                    <div className="lg:w-1/3">
                        <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                            <div className="flex items-center justify-center">
                            </div>
                            <Link to='/' className="btn bg-slate-200 text-xl h-52 w-48">
                    ...
                    <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                        <div className="space-y-3">
                            ...
                            <ul className="space-y-1">
                                ...
                                <li><Link to='/addspot'>Add Tourists Spot</Link>
                                </li>
                        ...
                        <div className="space-y-3">
                            ...
                            <ul className="space-y-1">
                                <li>
                                    <a rel="noopener noreferrer" href="#">Shaheen</a>
                                </li>
                                <li>
                ...
                <div className="py-6 text-sm text-center dark:text-gray-600">© 2024 Shahin Tourism. All rights reserved.</div>
            </footer>
        </>
    );
};
